...
- File môi trường `.env` (đã có file mẫu trong repo):
  > Kiểm tra bằng npm -v và node -v
...
Nếu dùng Ubuntu có thể chạy script tự động
...
Nếu chạy ở hệ điều hành khác
...
- Docker Hub: https://hub.docker.com/r/hieuduong1/devops-midterm-web/tags
- Domain URL https://devoops.shop
